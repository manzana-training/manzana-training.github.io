    ...
    <article className="min-h-screen">
      ...
      <div className="max-w-3xl mx-auto px-6 pt-24 pb-16">
        ...
        <div className="mt-16 border border-manzana-accent/20 p-8 text-center">
          ...
          <p className="mt-4">
            <a href="/diagnostico" data-track="clic_diagnostico" data-track-label="blog-cortar-la-infeccion" className="text-manzana-accent hover:text-manzana-white text-sm transition-colors">
