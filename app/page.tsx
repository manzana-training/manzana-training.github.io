  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="max-w-5xl mx-auto px-6 pt-24 pb-20">
        <div className="max-w-3xl">
          <h1 className="text-5xl md:text-7xl font-bold tracking-tight text-manzana-white leading-[1.1] mb-8">
            ...
            <span className="text-manzana-accent">bajo presion.</span>
          </h1>
          <p className="text-xl md:text-2xl text-manzana-mid leading-relaxed mb-4">
            Simulaciones practicas para lideres, founders y equipos que necesitan actuar ahora, no reflexionar seis meses.
          </p>
      ...
      <section className="max-w-5xl mx-auto px-6 py-20">
        <div className="max-w-3xl">
          <p className="text-manzana-accent text-sm font-mono mb-4">QUE HACEMOS</p>
          ...
          <div className="space-y-6 text-manzana-light/80 text-lg leading-relaxed">
            <p>
              MANZANA no es consultoria. No es coaching. No es un programa de liderazgo de 12 meses.
            </p>
            <p>
              Es un sistema de entrenamiento de reflejos bajo presion. Como defensa personal, pero para decisiones de negocio.
            </p>
            <p>
              Entrenamos con posiciones reales, principios simples, drills de repeticion y evaluacion por resultado. No por discurso.
            </p>
          </div>
        </div>
      </section>
      ...
      {/* Que obtienes */}
      <section className="max-w-5xl mx-auto px-6 py-20">
        <p className="text-manzana-accent text-sm font-mono mb-8">QUE OBTIENES</p>
        <div className="grid md:grid-cols-3 gap-8">
          {[
            {
              title: 'Claridad para decidir',
              desc: 'Cuando los datos no alcanzan y esperar no es opcion.',
            },
            {
            ...
            },
            {
              ...
              desc: 'Lenguaje comun para actuar cuando todo importa.',
            },
            {
            ...
            },
            {
              ...
              desc: '15 drills que cubren el 68% de las situaciones criticas.',
            },
            {
              title: 'Resultados en semanas',
              desc: 'Sin procesos eternos. Sin dependencias. Sin acompanamiento infinito.',
            },
          ].map((item, i) => (
      ...
      <section className="max-w-5xl mx-auto px-6 py-20">
        ...
        <h2 className="text-3xl md:text-4xl font-bold text-manzana-white mb-4">
          Escenarios reales. No teoria.
        </h2>
        <p className="text-manzana-mid text-lg mb-12 max-w-2xl">
          Cada posicion es una configuracion de presion que se repite en empresas reales. No dependen de industria. Se entrenan en una sesion.
        </p>
        <div className="grid md:grid-cols-2 gap-4">
          {[
            ...
            { num: '06', name: 'Cortar la infeccion', block: 'CONTAMINACION' },
            { num: '08', name: 'Parar la sangria', block: 'FRICCION' },
            { num: '11', name: 'Oxigeno o muerte', block: 'SUPERVIVENCIA' },
          ].map((pos, i) => (
