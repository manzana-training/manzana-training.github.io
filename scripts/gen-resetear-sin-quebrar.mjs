...
const prompt = `Minimalist dark editorial illustration. A dark ceramic vessel with a single visible fracture being mended with a thin seam of molten gold, kintsugi style, suspended against deep shadow. The gold line glows softly along the crack. Deep navy blue and dark sapphire tones with warm gold accent color (#E0C58F) only on the repair seam. No text. Abstract, moody, cinematic. Premium feel. Concept: repairing what broke instead of discarding it — the reset that makes the piece stronger, not the label that ends it.`
...
const out = path.join(__dirname, '..', 'public', 'blog-resetear-sin-quebrar.webp')
