...
const prompt = `Minimalist dark editorial illustration. A heavy, rusted iron anchor sinking slowly through dark water, chains trailing upward toward unseen surface light. Deep navy blue and dark sapphire tones with warm gold accent color (#E0C58F) catching the edge of the anchor. No text. Abstract, moody, cinematic. Premium feel. Concept: the cost of sustaining weight that should be released — decision to cut loose what no longer fits.`
...
const out = path.join(__dirname, '..', 'public', 'blog-soltar-el-lastre.webp')
